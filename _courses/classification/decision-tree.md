...
*   **Classification report**: The report shows details about the performance of the model for both the classes (Cat and Dog).
    ...
    *   **Precision**: Precision for Cat is 0.5, which means, out of all the cases model predicted as 'Cat', only 50% is actually a 'Cat'.
        
    *   **Recall**: Recall for Cat is 0.5, which means, out of all the actual 'Cat' cases, the model predicted 50% of them correctly.
